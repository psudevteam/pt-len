    ...
    >
      <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
        <div className="flex flex-col gap-y-4 mb-4">
          <span className="text-white font-medium  w-full block text-2xl">Reservasi Tamu</span>
        ...
        <ul className="space-y-2 font-medium">
          ...
          <li>
            <Link
              href="/dashboard/reservasi?title=Data Reservasi"
            ...
            >
              ...
              <span className="flex-1 ms-3 whitespace-nowrap">Daftar Reservasi</span>
            </Link>
          </li>
